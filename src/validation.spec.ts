...
assert.strictEqual(validateAccuracy('0.5'), true);  // Test string input
...
assert.strictEqual(validateApproximateSize('10'), true);  // Test string input
assert.strictEqual(validateApproximateSize('abc'), false);

// Tests for validateConfidence (reuses validateAccuracy tests)
// ... (you can copy the tests from validateAccuracy)
...
assert.strictEqual(validateConfidence('0.5'), true);  // Test string input
